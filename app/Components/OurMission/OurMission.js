    ...
    <div className='our-mission-container'>
        ...
        <div className='backed-up'>
            ...
            <div className='backed-up-contents'>
                <img src="/company1.png" alt="" className='backed-up-img' />
                <img src="/company2.png" alt="" className='backed-up-img'/>
                <img src="/company3.png" alt="" className='backed-up-img'/>
                <img src="/company1.png" alt="" className='backed-up-img' />
                <img src="/company4.png" alt="" className='backed-up-img'/>
                <img src="/company1.png" alt="" className='backed-up-img' />
                <img src="/company2.png" alt="" className='backed-up-img'/>
            </div>
